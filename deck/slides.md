...
<div class="max-w-3xl mx-auto relative z-10">
  ...
  <p class="teal mt-10 !text-xl font-semibold !leading-relaxed">
    ...
    We design a habitat they can grow in.
  </p>
</div>
...
<div class="max-w-3xl mx-auto">
  ...
  <div class="grid grid-cols-2 gap-x-8 gap-y-4">
    <div class="flex items-start gap-3">
      ...
      <div>
        <p class="bright !text-base font-semibold !m-0">Identity</p>
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <p class="bright !text-base font-semibold !m-0">Money</p>
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <p class="bright !text-base font-semibold !m-0">Infrastructure</p>
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <p class="bright !text-base font-semibold !m-0">Reputation</p>
  ...
  <div class="grid grid-cols-2 gap-x-10 gap-y-5 text-left">
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="!text-sm jelly-body !m-0 !mt-1">Inherited starting position.</p>
      </div>
    </div>
    <div class="flex items-start gap-3">
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="!text-sm jelly-body !m-0 !mt-1">Writes its own harness.</p>
      </div>
    </div>
    <div class="flex items-start gap-3">
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="!text-sm jelly-body !m-0 !mt-1">A coherent story of self.</p>
      </div>
    </div>
    <div class="flex items-start gap-3">
