...
ensure_lane() {
  ...
  local bootstrap
  bootstrap="Read $strategy_path section role_packages.$role for your startup_prompt and standing_orders. Follow them exactly. Loop on your role's work continuously; never halt at an input prompt unless a standing_order explicitly requires it."
